...
class ConversationWindow:
    ...
    def add_message(self, message: Dict[str, str]):
        ...
        while (len(self.messages) > self.max_messages or 
               self.token_count > self.max_tokens) and self.messages:
...
class AnthropicClient:
    ...
    def get_archived_messages(self, start_date: Optional[datetime] = None,
    ...
    def send_message(self, prompt: str, system: str = None, tools_used: List[Dict] = None) -> str:
    ...
    def _log_interaction(self, prompt: str, summary: str, response: str = None, tools_used: List[Dict] = None):
